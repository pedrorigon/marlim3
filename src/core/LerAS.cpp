        ...
        if (nASIPR < 1) {
            ...
            for (int iIPR = 0; iIPR < nASIPR; iIPR++) {
                ...
                if (IPR_json[iIPR].HasMember("presEstatica")) {
                    ...
                    ASIPR[iIPR].parseriePres = 0;
                if (ASIPR[iIPR].parseriePres > 0)
                    nVariaveis *= ASIPR[iIPR].parseriePres;
                if (IPR_json[iIPR].HasMember("tempRes")) {
                    ...
                    ASIPR[iIPR].parserieTemp = 0;
                if (ASIPR[iIPR].parserieTemp > 0)
                    nVariaveis *= ASIPR[iIPR].parserieTemp;
                if (IPR_json[iIPR].HasMember("IP")) {
                    ...
                    ASIPR[iIPR].parserieIP = 0;
                if (ASIPR[iIPR].parserieIP > 0)
                    nVariaveis *= ASIPR[iIPR].parserieIP;
                ...
                if (IPR_json[iIPR].HasMember("II")) {
                    ...
                    ASIPR[iIPR].parserieJP = 0;
                if (ASIPR[iIPR].parserieJP > 0)
                    nVariaveis *= ASIPR[iIPR].parserieJP;
                if (IPR_json[iIPR].HasMember("fluido")) {
                    ...
                    ASIPR[iIPR].parserieFlup = 0;
                if (ASIPR[iIPR].parserieFlup > 0)
                    nVariaveis *= ASIPR[iIPR].parserieFlup;
        ...
        if (nASFL < 1) {
            ...
            for (int iFL = 0; iFL < nASFL; iFL++) {
                ...
                if (FonLiq_json[iFL].HasMember("temperatura")) {
                    ...
                    ASFonLiq[iFL].parserieTemp = 0;
                if (ASFonLiq[iFL].parserieTemp > 0)
                    nVariaveis *= ASFonLiq[iFL].parserieTemp;
                if (FonLiq_json[iFL].HasMember("vazLiq")) {
                    ...
                    ASFonLiq[iFL].parserieVL = 0;
                if (ASFonLiq[iFL].parserieVL > 0)
                    nVariaveis *= ASFonLiq[iFL].parserieVL;
                if (FonLiq_json[iFL].HasMember("beta")) {
                    ...
                    ASFonLiq[iFL].parserieBet = 0;
                if (ASFonLiq[iFL].parserieBet > 0)
                    nVariaveis *= ASFonLiq[iFL].parserieBet;
                if (FonLiq_json[iFL].HasMember("fluido")) {
                    ...
                    ASFonLiq[iFL].parserieFlu = 0;
                if (ASFonLiq[iFL].parserieFlu > 0)
                    nVariaveis *= ASFonLiq[iFL].parserieFlu;
        ...
        if (nASFG < 1) {
            ...
            for (int iFG = 0; iFG < nASFG; iFG++) {
                ...
                if (FonGas_json[iFG].HasMember("temperatura")) {
                    ...
                    ASFonGas[iFG].parserieTemp = 0;
                if (ASFonGas[iFG].parserieTemp > 0)
                    nVariaveis *= ASFonGas[iFG].parserieTemp;
                if (FonGas_json[iFG].HasMember("vazGas")) {
                    ...
                    ASFonGas[iFG].parserieVazG = 0;
                if (ASFonGas[iFG].parserieVazG > 0)
                    nVariaveis *= ASFonGas[iFG].parserieVazG;
                if (FonGas_json[iFG].HasMember("vazComp")) {
                    ...
                    ASFonGas[iFG].parserieVazC = 0;
                if (ASFonGas[iFG].parserieVazC > 0)
                    nVariaveis *= ASFonGas[iFG].parserieVazC;
        ...
        if (nASFM < 1) {
            ...
            for (int iFM = 0; iFM < nASFM; iFM++) {
                ...
                if (FonMas_json[iFM].HasMember("temperatura")) {
                    ...
                    ASFonMas[iFM].parserieTemp = 0;
                if (ASFonMas[iFM].parserieTemp > 0)
                    nVariaveis *= ASFonMas[iFM].parserieTemp;
                if (FonMas_json[iFM].HasMember("vazaoProd")) {
                    ...
                    ASFonMas[iFM].parserieMP = 0;
                if (ASFonMas[iFM].parserieMP > 0)
                    nVariaveis *= ASFonMas[iFM].parserieMP;
                if (FonMas_json[iFM].HasMember("VazaoComp")) {
                    ...
                    ASFonMas[iFM].parserieMC = 0;
                if (ASFonMas[iFM].parserieMC > 0)
                    nVariaveis *= ASFonMas[iFM].parserieMC;
                if (FonMas_json[iFM].HasMember("VazaoGas")) {
                    ...
                    ASFonMas[iFM].parserieMG = 0;
                if (ASFonMas[iFM].parserieMG > 0)
                    nVariaveis *= ASFonMas[iFM].parserieMG;
                if (FonMas_json[iFM].HasMember("fluido")) {
                    ...
                    ASFonMas[iFM].parserieFlu = 0;
                if (ASFonMas[iFM].parserieFlu > 0)
                    nVariaveis *= ASFonMas[iFM].parserieFlu;
        ...
        if (nASBCS < 1) {
            ...
            for (int indBCS = 0; indBCS < nASBCS; indBCS++) {
                ...
                if (BCS_json[indBCS].HasMember("frequencia")) {
                    ...
                    ASBCS[indBCS].parserieFreq = 0;
                if (ASBCS[indBCS].parserieFreq > 0)
                    nVariaveis *= ASBCS[indBCS].parserieFreq;
                if (BCS_json[indBCS].HasMember("estagio")) {
                    ...
                    ASBCS[indBCS].parserieEstag = 0;
                if (ASBCS[indBCS].parserieEstag > 0)
                    nVariaveis *= ASBCS[indBCS].parserieEstag;
        ...
        if (nASBV < 1) {
            ...
            for (int indBCS = 0; indBCS < nASBV; indBCS++) {
                ...
                if (BVol_json[indBCS].HasMember("frequencia")) {
                    ...
                    ASBVOL[indBCS].parserieFreq = 0;
                if (ASBVOL[indBCS].parserieFreq > 0)
                    nVariaveis *= ASBVOL[indBCS].parserieFreq;
                if (BVol_json[indBCS].HasMember("capacidade")) {
                    ...
                    ASBVOL[indBCS].parserieCap = 0;
                if (ASBVOL[indBCS].parserieCap > 0)
                    nVariaveis *= ASBVOL[indBCS].parserieCap;
                if (BVol_json[indBCS].HasMember("fatorPoli")) {
                    ...
                    ASBVOL[indBCS].parserieNPoli = 0;
                if (ASBVOL[indBCS].parserieNPoli > 0)
                    nVariaveis *= ASBVOL[indBCS].parserieNPoli;
        ...
        if (nASDP < 1) {
            ...
            for (int indBCS = 0; indBCS < nASDP; indBCS++) {
                ...
                if (DP_json[indBCS].HasMember("deltapressao")) {
                    ...
                    ASDP[indBCS].parserieDP = 0;
                if (ASDP[indBCS].parserieDP > 0)
                    nVariaveis *= ASDP[indBCS].parserieDP;
        ...
        if (nASdPdLH < 1) {
            ...
            for (int indBCS = 0; indBCS < nASdPdLH; indBCS++) {
                ...
                if (dPdLHidro_json[indBCS].HasMember("fator")) {
                    ...
                    ASdPdLH[indBCS].parserieDPHidro = 0;
                if (ASdPdLH[indBCS].parserieDPHidro > 0)
                    nVariaveis *= ASdPdLH[indBCS].parserieDPHidro;
        ...
        if (nASdPdLF < 1) {
            ...
            for (int indBCS = 0; indBCS < nASdPdLF; indBCS++) {
                ...
                if (dPdLFric_json[indBCS].HasMember("fator")) {
                    ...
                    ASdPdLF[indBCS].parserieDPFric = 0;
                if (ASdPdLF[indBCS].parserieDPFric > 0)
                    nVariaveis *= ASdPdLF[indBCS].parserieDPFric;
        ...
        if (nASdTdL < 1) {
            ...
            for (int indBCS = 0; indBCS < nASdTdL; indBCS++) {
                ...
                if (dTdL_json[indBCS].HasMember("fator")) {
                    ...
                    ASdTdL[indBCS].parserieDT = 0;
                if (ASdTdL[indBCS].parserieDT > 0)
                    nVariaveis *= ASdTdL[indBCS].parserieDT;
        ...
        if (nASV < 1) {
            ...
            for (int indBCS = 0; indBCS < nASV; indBCS++) {
                ...
                if (Valv_json[indBCS].HasMember("abertura")) {
                    ...
                    ASValv[indBCS].parserieAbre = 0;
                if (ASValv[indBCS].parserieAbre > 0)
                    nVariaveis *= ASValv[indBCS].parserieAbre;
                if (Valv_json[indBCS].HasMember("CD")) {
                    ...
                    ASValv[indBCS].parserieCD = 0;
                if (ASValv[indBCS].parserieCD > 0)
                    nVariaveis *= ASValv[indBCS].parserieCD;
        ...
        if (nASFuro < 1) {
            ...
            for (int indBCS = 0; indBCS < nASFuro; indBCS++) {
                ...
                if (Furo_json[indBCS].HasMember("abertura")) {
                    ...
                    ASFuro[indBCS].parserieAbre = 0;
                if (ASFuro[indBCS].parserieAbre > 0)
                    nVariaveis *= ASFuro[indBCS].parserieAbre;
                if (Furo_json[indBCS].HasMember("CD")) {
                    ...
                    ASFuro[indBCS].parserieCD = 0;
                if (ASFuro[indBCS].parserieCD > 0)
                    nVariaveis *= ASFuro[indBCS].parserieCD;
                if (Furo_json[indBCS].HasMember("beta")) {
                    ...
                    ASFuro[indBCS].parserieBeta = 0;
                if (ASFuro[indBCS].parserieBeta > 0)
                    nVariaveis *= ASFuro[indBCS].parserieBeta;
                if (Furo_json[indBCS].HasMember("pressao")) {
                    ...
                    ASFuro[indBCS].parseriePres = 0;
                if (ASFuro[indBCS].parseriePres > 0)
                    nVariaveis *= ASFuro[indBCS].parseriePres;
                if (Furo_json[indBCS].HasMember("temperatura")) {
                    ...
                    ASFuro[indBCS].parserieTemp = 0;
                if (ASFuro[indBCS].parserieTemp > 0)
                    nVariaveis *= ASFuro[indBCS].parserieTemp;
                if (Furo_json[indBCS].HasMember("fluido")) {
                    ...
                    ASFuro[indBCS].parserieFlu = 0;
                if (ASFuro[indBCS].parserieFlu > 0)
                    nVariaveis *= ASFuro[indBCS].parserieFlu;
        ...
        if (nASGeom < 1) {
            ...
            for (int iG = 0; iG < nASGeom; iG++) {
                ...
                if (secaoTransversal_json[iG].HasMember("DiamIntMaior")) {
                    ...
                    ASGeom[iG].parserieA = 0;
                if (ASGeom[iG].parserieA > 0)
                    nVariaveis *= ASGeom[iG].parserieA;
                if (secaoTransversal_json[iG].HasMember("DiamIntMenor")) {
                    ...
                    ASGeom[iG].parserieB = 0;
                if (ASGeom[iG].parserieB > 0)
                    nVariaveis *= ASGeom[iG].parserieB;
                if (secaoTransversal_json[iG].HasMember("Rugosidade")) {
                    ...
                    ASGeom[iG].parserieRug = 0;
                if (ASGeom[iG].parserieRug > 0)
                    nVariaveis *= ASGeom[iG].parserieRug;
        ...
        if (nASCondEquiv < 1) {
            ...
            for (int ik = 0; ik < nASCondEquiv; ik++) {
                ...
                if (CondEquiv_json[ik].HasMember("condutividade")) {
                    ...
                    ASCondEquiv[ik].parserieK = 0;
                if (ASCondEquiv[ik].parserieK > 0)
                    nVariaveis *= ASCondEquiv[ik].parserieK;
...
void ASens::parse_Psep(Value &Psep_json) {
    ...
    if (Psep_json.HasMember("pressao")) {
        ...
        ASPsep.parseriePres = 0;
    if (ASPsep.parseriePres > 0)
        nVariaveis *= ASPsep.parseriePres;
...
void ASens::parse_RGO(Value &RGO_json) {
    ...
    if (RGO_json.HasMember("RGO")) {
        ...
        ASRGO.parserieRGO = 0;
    if (ASRGO.parserieRGO > 0)
        nVariaveis *= ASRGO.parserieRGO;
...
void ASens::parse_BSW(Value &BSW_json) {
    ...
    if (BSW_json.HasMember("BSW")) {
        ...
        ASBSW.parserieBSW = 0;
    if (ASBSW.parserieBSW > 0)
        nVariaveis *= ASBSW.parserieBSW;
...
void ASens::parse_GasInj(Value &GasInj_json) {
    ...
    if (GasInj_json.HasMember("presInj")) {
        ...
        ASGasInj.parseriePresInj = 0;
    if (ASGasInj.parseriePresInj > 0)
        nVariaveis *= ASGasInj.parseriePresInj;
    if (GasInj_json.HasMember("temperatura")) {
        ...
        ASGasInj.parserieTemp = 0;
    if (ASGasInj.parserieTemp > 0)
        nVariaveis *= ASGasInj.parserieTemp;
    if (GasInj_json.HasMember("vazGas")) {
        ...
        ASGasInj.parserieVazGas = 0;
    if (ASGasInj.parserieVazGas > 0)
        nVariaveis *= ASGasInj.parserieVazGas;
...
void ASens::parse_CHK(Value &CHK_json) {
    ...
    if (CHK_json.HasMember("abertura")) {
        ...
        ASCHK.parserieAbre = 0;
    if (ASCHK.parserieAbre > 0)
        nVariaveis *= ASCHK.parserieAbre;
...
void ASens::parse_Pent(Value &Pent_json) {
    ...
    if (Pent_json.HasMember("pressao")) {
        ...
        ASpEntrada.parseriePres = 0;
    if (ASpEntrada.parseriePres > 0)
        nVariaveis *= ASpEntrada.parseriePres;
    if (Pent_json.HasMember("temperatura")) {
        ...
        ASpEntrada.parserieTemp = 0;
    if (ASpEntrada.parserieTemp > 0)
        nVariaveis *= ASpEntrada.parserieTemp;
    if (Pent_json.HasMember("titulo")) {
        ...
        ASpEntrada.parserieTit = 0;
    if (ASpEntrada.parserieTit > 0)
        nVariaveis *= ASpEntrada.parserieTit;
    if (Pent_json.HasMember("beta")) {
        ...
        ASpEntrada.parserieBet = 0;
    if (ASpEntrada.parserieBet > 0)
        nVariaveis *= ASpEntrada.parserieBet;
...
void ASens::parse_VPent(Value &VPent_json) {
    ...
    if (VPent_json.HasMember("pressao")) {
        ...
        ASvpEntrada.parseriePres = 0;
    if (ASvpEntrada.parseriePres > 0)
        nVariaveis *= ASvpEntrada.parseriePres;
    if (VPent_json.HasMember("temperatura")) {
        ...
        ASvpEntrada.parserieTemp = 0;
    if (ASvpEntrada.parserieTemp > 0)
        nVariaveis *= ASvpEntrada.parserieTemp;
    if (VPent_json.HasMember("vazMass")) {
        ...
        ASvpEntrada.parserieMass = 0;
    if (ASvpEntrada.parserieMass > 0)
        nVariaveis *= ASvpEntrada.parserieMass;
    if (VPent_json.HasMember("beta")) {
        ...
        ASvpEntrada.parserieBet = 0;
    if (ASvpEntrada.parserieBet > 0)
        nVariaveis *= ASvpEntrada.parserieBet;
...
void ASens::parse_injecPoco(Value &injecP_json) {
    ...
    if (injecP_json.HasMember("pressaoInj")) {
        ...
        ASPInj.parseriePresI = 0;
    if (ASPInj.parseriePresI > 0)
        nVariaveis *= ASPInj.parseriePresI;
    if (injecP_json.HasMember("pressaoFinal")) {
        ...
        ASPInj.parseriePresFundo = 0;
    if (ASPInj.parseriePresFundo > 0)
        nVariaveis *= ASPInj.parseriePresFundo;
    if (injecP_json.HasMember("temperatura")) {
        ...
        ASPInj.parserieTemp = 0;
    if (ASPInj.parserieTemp > 0)
        nVariaveis *= ASPInj.parserieTemp;
    if (injecP_json.HasMember("temperatura")) {
        dim++;
        ...
        ASPInj.parserieVaz = 0;
    if (ASPInj.parserieVaz > 0)
        nVariaveis *= ASPInj.parserieVaz;
    ...
    if (listaV.vbcs == 1) {
        ...
        for (int indBCS = 0; indBCS < nASBCS; indBCS++) {
            ...
            if (ASBCS[indBCS].parserieEstag > 0) {
                ...
                escreveIni << seq << " : " << " indice BCS = " << konta2 << " celula Fonte " << icel << " indice N. Estagios= " << ind << " N. Estagios= " << ASBCS[indBCS].nestag[ind] << "\n";
                konta2++;
            }
        }
    }
...
void ASens::selecaoAS(int ncelG, choke &chokeSup, Cel *celula, CelG *celulaG, ProFlu *flup,
    ...
    if (listaV.vRGO == 1) {
        ...
        if (flup[0].flashCompleto != 2) {
            ...
            atualizaCompRGO(ASRGO.RGO[ind], flup[0]);
    ...
    if (listaV.vfongas == 1) {
        ...
        for (int iFG = 0; iFG < nASFG; iFG++) {
            ...
            if (ASFonGas[iFG].parserieTemp > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Gas = " << konta1 << " celula Fonte " << icel << " indice Temperatura = " << ind << " Temperatura= " << ASFonGas[iFG].temp[ind] << "\n";
                konta1++;
            }
            if (ASFonGas[iFG].parserieVazG > 0) {
                ind = sequenciaAS[seq].FGvazgas[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Gas = " << konta2 << " celula Fonte " << icel << " indice Vazao Gas = " << ind << " Vazao Gas= " << ASFonGas[iFG].vazgas[ind] << "\n";
                konta2++;
            }
            if (ASFonGas[iFG].parserieVazC > 0) {
                ind = sequenciaAS[seq].FGvazcomp[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Gas = " << konta3 << " celula Fonte " << icel << " indice Vazao Liq Complementar = " << ind << " Vazao Liq Complementar= " << ASFonGas[iFG].vazcomp[ind] << "\n";
                konta3++;
            }
        }
    }
    if (listaV.vbcs == 1) {
        ...
        for (int indBCS = 0; indBCS < nASBCS; indBCS++) {
            ...
            if (ASBCS[indBCS].parserieFreq > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice BCS = " << konta1 << " celula Fonte " << icel << " indice Frequencia= " << ind << " Frequencia= " << ASBCS[indBCS].freq[ind] << "\n";
                konta1++;
            }
            if (ASBCS[indBCS].parserieEstag > 0) {
                ind = sequenciaAS[seq].BCSnestag[konta2];
    ...
    if (listaV.vfonliq == 1) {
        ...
        for (int iFL = 0; iFL < nASFL; iFL++) {
            ...
            if (ASFonLiq[iFL].parserieTemp > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Liquido = " << konta1 << " celula Fonte " << icel << " indice Temperatura = " << ind << " Temperatura= " << ASFonLiq[iFL].temp[ind] << "\n";
                konta1++;
            }
            if (ASFonLiq[iFL].parserieVL > 0) {
                ind = sequenciaAS[seq].FLvazliq[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Liquido = " << konta2 << " celula Fonte " << icel << " indice Vazao Liq = " << ind << " Vazao de Liquido= " << ASFonLiq[iFL].vazliq[ind] << "\n";
                konta2++;
            }
            if (ASFonLiq[iFL].parserieBet > 0) {
                ind = sequenciaAS[seq].FLbet[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Liquido = " << konta3 << " celula Fonte " << icel << " indice Beta = " << ind << " Beta= " << ASFonLiq[iFL].bet[ind] << "\n";
                konta3++;
            }
            if (ASFonLiq[iFL].parserieFlu > 0) {
                ind = sequenciaAS[seq].FLindfluP[konta4];
    ...
    if (listaV.vipr == 1) {
        ...
        for (int iIPR = 0; iIPR < nASIPR; iIPR++) {
            ...
            if (ASIPR[iIPR].parserieTemp > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta1 << " celula Fonte " << icel << " indice Temperatura = " << ind << " Temperatura= " << ASIPR[iIPR].temp[ind] << "\n";
                konta1++;
            }
            if (ASIPR[iIPR].parseriePres > 0) {
                ind = sequenciaAS[seq].IPRpres[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta2 << " celula Fonte " << icel << " indice P Estatica = " << ind << " P Estatica= " << ASIPR[iIPR].pres[ind] << "\n";
                konta2++;
            }
            if (ASIPR[iIPR].parserieIP > 0) {
                ind = sequenciaAS[seq].IPRip[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta3 << " celula Fonte " << icel << " indice IP = " << ind << " IP= " << ASIPR[iIPR].ip[ind] << "\n";
                konta3++;
            }
            if (ASIPR[iIPR].parserieJP > 0) {
                ind = sequenciaAS[seq].IPRjp[konta4];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta4 << " celula Fonte " << icel << " indice II = " << ind << " II= " << ASIPR[iIPR].jp[ind] << "\n";
                konta4++;
            }
            if (ASIPR[iIPR].parserieqMax > 0) {
                ind = sequenciaAS[seq].IPRqMax[konta5];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta5 << " celula Fonte " << icel << " indice qMax = " << ind << " qMax= " << ASIPR[iIPR].qMax[ind] << "\n";
                konta5++;
            }
            if (ASIPR[iIPR].parserieFlup > 0) {
                ind = sequenciaAS[seq].IPRindfluP[konta6];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice IPR = " << konta6 << " celula Fonte " << icel << " indice Fluido = " << ind << " fluido= " << ASIPR[iIPR].indfluP[ind] << "\n";
                konta6++;
            }
        }
    }
    ...
    if (listaV.vfonmas == 1) {
        ...
        for (int iFM = 0; iFM < nASFM; iFM++) {
            ...
            if (ASFonMas[iFM].parserieTemp > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Massa = " << konta1 << " celula Fonte " << icel << " indice Temperatura = " << ind << " Temperatura= " << ASFonMas[iFM].temp[ind] << "\n";
                konta1++;
            }
            if (ASFonMas[iFM].parserieMP > 0) {
                ind = sequenciaAS[seq].FMvazMasP[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Massa = " << konta2 << " celula Fonte " << icel << " indice Vazao Liquido= " << ind << " Vazao Liquido= " << ASFonMas[iFM].vazMasP[ind] << "\n";
                konta2++;
            }
            if (ASFonMas[iFM].parserieMC > 0) {
                ind = sequenciaAS[seq].FMvazMasC[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Massa = " << konta3 << " celula Fonte " << icel << " indice Vazao Liquido Complementar= " << ind << " Vazao Liquido Complementar= " << ASFonMas[iFM].vazMasC[ind] << "\n";
                konta3++;
            }
            if (ASFonMas[iFM].parserieMG > 0) {
                ind = sequenciaAS[seq].FMvazMasG[konta4];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Massa = " << konta4 << " celula Fonte " << icel << " indice Vazao Gas= " << ind << " Vazao Gas= " << ASFonMas[iFM].vazMasG[ind] << "\n";
                konta4++;
            }
            if (ASFonMas[iFM].parserieFlu > 0) {
                ind = sequenciaAS[seq].FMindfluP[konta5];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Fonte Massa = " << konta5 << " celula Fonte " << icel << " indice Fluido= " << ind << " Fluido= " << ASFonMas[iFM].indfluP[ind] << "\n";
                konta5++;
            }
        }
    }
    if (listaV.vdp == 1) {
        ...
        for (int indBCS = 0; indBCS < nASDP; indBCS++) {
            ...
            if (ASDP[indBCS].parserieDP > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Del. Pres, = " << konta1 << " celula Fonte " << icel << " indice Del. Pres.= " << ind << " Del. Pres.= " << ASDP[indBCS].dp[ind] << "\n";
                konta1++;
            }
        }
    }
    if (listaV.vdpH == 1) {
        ...
        for (int indBCS = 0; indBCS < nASdPdLH; indBCS++) {
            ...
            if (ASdPdLH[indBCS].parserieDPHidro > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Corr. Pres. Hidro, = " << konta1 << " indice da colecao de fatores de correcao " << icel << " indice na AS.= " << ind << " Corr. Pres. Hidro= " << ASdPdLH[indBCS].dPHidro[ind] << "\n";
                konta1++;
            }
        }
    }
    if (listaV.vdpF == 1) {
        ...
        for (int indBCS = 0; indBCS < nASdPdLF; indBCS++) {
            ...
            if (ASdPdLF[indBCS].parserieDPFric > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Corr. Pres. Fric., = " << konta1 << " indice da colecao de fatores de correcao " << icel << " indice na AS.= " << ind << " Corr. Pres. Fric.= " << ASdPdLF[indBCS].dPFric[ind] << "\n";
                konta1++;
            }
        }
    }
    if (listaV.vdt == 1) {
        ...
        for (int indBCS = 0; indBCS < nASdTdL; indBCS++) {
            ...
            if (ASdTdL[indBCS].parserieDT > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Corr. Temperatura, = " << konta1 << " indice da colecao de fatores de correcao " << icel << " indice na AS.= " << ind << " Corr. Temperatura= " << ASdTdL[indBCS].dT[ind] << "\n";
                konta1++;
            }
        }
    }
    ...
    if (listaV.vbvol == 1) {
        ...
        for (int indBCS = 0; indBCS < nASBV; indBCS++) {
            ...
            if (ASBVOL[indBCS].parserieFreq > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Bomba Vol., = " << konta1 << " celula Fonte " << icel << " indice Frequencia= " << ind << " Frequencia= " << ASBVOL[indBCS].freq[ind] << "\n";
                konta1++;
            }
            if (ASBVOL[indBCS].parserieCap > 0) {
                ind = sequenciaAS[seq].BVOLcapacidade[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Bomba Vol., = " << konta2 << " celula Fonte " << icel << " indice Capacidade= " << ind << " Capacidade= " << ASBVOL[indBCS].capacidade[ind] << "\n";
                konta2++;
            }
            if (ASBVOL[indBCS].parserieNPoli > 0) {
                ind = sequenciaAS[seq].BVOLnpoli[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Bomba Vol., = " << konta3 << " celula Fonte " << icel << " indice Fator Politropico= " << ind << " Fator Politropico= " << ASBVOL[indBCS].npoli[ind] << "\n";
                konta3++;
            }
        }
    }
    if (listaV.vvalv == 1) {
        ...
        for (int indBCS = 0; indBCS < nASV; indBCS++) {
            ...
            if (ASValv[indBCS].parserieAbre > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Valvula, = " << konta1 << " celula Fonte " << icel << " indice Abertura= " << ind << " Abertura= " << ASValv[indBCS].abertura[ind] << "\n";
                konta1++;
            }
            if (ASValv[indBCS].parserieCD > 0) {
                ind = sequenciaAS[seq].VALVcd[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Valvula, = " << konta2 << " celula Fonte " << icel << " indice CD= " << ind << " CD= " << ASValv[indBCS].cd[ind] << "\n";
                konta2++;
            }
        }
    }
    if (listaV.vfuro == 1) {
        ...
        for (int indBCS = 0; indBCS < nASFuro; indBCS++) {
            ...
            if (ASFuro[indBCS].parserieAbre > 0) {
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Vazamento = " << konta1 << " celula Fonte " << icel << " indice Abertura= " << ind << " Abertura= " << ASFuro[indBCS].abertura[ind] << "\n";
                konta1++;
            }
            if (ASFuro[indBCS].parserieCD > 0) {
                ind = sequenciaAS[seq].FUROcd[konta2];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Vazamento = " << konta2 << " celula Fonte " << icel << " indice CD= " << ind << " CD= " << ASFuro[indBCS].cd[ind] << "\n";
                konta2++;
            }
            if (ASFuro[indBCS].parserieBeta > 0) {
                ind = sequenciaAS[seq].FURObeta[konta3];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Vazamento = " << konta3 << " celula Fonte " << icel << " indice Beta= " << ind << " Beta= " << ASFuro[indBCS].beta[ind] << "\n";
                konta3++;
            }
            if (ASFuro[indBCS].parseriePres) {
                ind = sequenciaAS[seq].FUROpres[konta4];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Vazamento = " << konta4 << " celula Fonte " << icel << " indice Pressao= " << ind << " Pressao= " << ASFuro[indBCS].pres[ind] << "\n";
                konta4++;
            }
            if (ASFuro[indBCS].parserieTemp > 0) {
                ind = sequenciaAS[seq].FUROtemp[konta5];
                ...
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Vazamento = " << konta5 << " celula Fonte " << icel << " indice Temperatura= " << ind << " Temperatura= " << ASFuro[indBCS].temp[ind] << "\n";
                konta5++;
            }
            if (ASFuro[indBCS].parserieFlu > 0) {
                ind = sequenciaAS[seq].FUROindFlu[konta6];
    ...
    if (listaV.diam == 1) {
        ...
        for (int iG = 0; iG < nASGeom; iG++) {
            if (ASGeom[iG].parserieA > 0) {
                ...
                int igeo = ASGeom[iG].indGeom;
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Secao Transversal = " << konta1 << " secao transversal " << igeo << " indice Maior Diametro = " << ind << " Maior Diam Interno= " << ASGeom[iG].dA[ind] << "\n";
                konta1++;
            ...
            if (ASGeom[iG].parserieB > 0) {
                ...
                int igeo = ASGeom[iG].indGeom;
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Secao Transversal = " << konta2 << " secao transversal " << igeo << " indice Menor Diametro = " << ind << " Menor Diam Interno= " << ASGeom[iG].dB[ind] << "\n";
                konta2++;
            ...
            if (ASGeom[iG].parserieRug > 0) {
                ...
                int igeo = ASGeom[iG].indGeom;
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Secao Transversal = " << konta3 << " secao transversal " << igeo << " indice Rugosidade = " << ind << " Rugosidade= " << ASGeom[iG].rug[ind] << "\n";
                konta3++;
    ...
    if (listaV.kequiv == 1) {
        ...
        for (int ik = 0; ik < nASCondEquiv; ik++) {
            if (ASCondEquiv[ik].parserieK > 0) {
                ...
                int imat = ASCondEquiv[ik].indMat;
                if (imprime == 1)
                    escreveIni << seq << " : " << " indice Material = " << konta1 << " material " << imat << " indice Condutividade = " << ind << " Condutividade= " << ASCondEquiv[ik].cond[ind] << "\n";
                konta1++;
    ...
    if (listaV.vgasinj == 1) {
        if (ASGasInj.parseriePresInj > 0) {
            ...
            if (imprime == 1)
                escreveIni << seq << " : " << " indice Pressao Injecao = " << ind << " Pressao Injecao= " << ASGasInj.presinj[ind] << "\n";
        }
        if (ASGasInj.parserieTemp > 0) {
            ind = sequenciaAS[seq].INJGtemperatura;
            tempiniG = ASGasInj.temperatura[ind];
            if (imprime == 1)
                escreveIni << seq << " : " << " indice Temp Injecao = " << ind << " Temp Injecao= " << ASGasInj.temperatura[ind] << "\n";
        }
        if (ASGasInj.parserieVazGas > 0) {
            ind = sequenciaAS[seq].INJGvazgas;
            vazgasG = ASGasInj.vazgas[ind];
            if (imprime == 1)
                escreveIni << seq << " : " << " indice Vaz Injecao = " << ind << " Vaz Injecao= " << ASGasInj.vazgas[ind] << "\n";
        }
    }
    if (listaV.vpresent == 1) {
        if (ASpEntrada.parseriePres > 0) {
    ...
    if (listaV.vchk == 1) {
        if (ASCHK.parserieAbre > 0) {
            ...
            if (imprime == 1)
                escreveIni << seq << " : " << " indice Abertura Choke = " << ind << " Abertura Choke= " << ASCHK.abertura[ind] << "\n";
        }
        if (ASCHK.parserieCD > 0) {
            ind = sequenciaAS[seq].CHKcd;
...
void ASens::tabelaGenerica(int ncelG, choke &chokeSup, Cel *celula, CelG *celulaG, ProFlu *flup,
    ...
    if (vfp == 0) {
        ...
        if (chrisao == ASPsep.parseriePres)
            escreveIni1 << BHP << "   " << "\n";
        if (chrisao == ASPsep.parseriePres)
            chrisao = 0;
    }
    ...
    if (vfp == 1) {
        ...
        if (chrisao == ASFonLiq->parserieVL)
            escreveIni2 << BHP << "   /" << "\n";
        if (chrisao == ASFonLiq->parserieVL)
            chrisao = 0;
    }

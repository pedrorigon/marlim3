...
inline double poettmannFriction(double x) {
    if (x <= 1.09861000000000009e+00) return 2.07943999999999996e+00;
    if (x >= 4.78749000000000002e+00) return -5.33914000000000044e+00;
...
inline double baxendellFriction(double x) {
    if (x <= 1.09861000000000009e+00) return 2.07943999999999996e+00;
    if (x >= 4.78749000000000002e+00) return -3.97389999999999999e+00;
...
inline double fancherFriction1500(double x) {
    if (x <= 1.09861000000000009e+00) return 4.69999999999999973e-01;
    if (x >= 4.78749000000000002e+00) return -4.60517000000000021e+00;
...
inline double fancherFriction2250(double x) {
    if (x <= 1.09861000000000009e+00) return -9.67579999999999996e-01;
    if (x >= 4.78749000000000002e+00) return -5.29832000000000036e+00;
...
inline double fancherFriction3000(double x) {
    if (x <= 1.09861000000000009e+00) return -1.71480000000000010e+00;
    if (x >= 4.78749000000000002e+00) return -6.11929999999999996e+00;
...
inline double fancherFrictionInterp(double logFlowParam, double glr) {
    if (glr <= 1500.0) return fancherFriction1500(logFlowParam);
    if (glr >= 3000.0) return fancherFriction3000(logFlowParam);
...
inline double hagedornHoldup(double x) {
    if (x <= -1.31223630000000000e+01) return 4.00000000000000008e-02;
    if (x >= -4.60517000000000021e+00) return 1.00000000000000000e+00;
...
inline double hagedornCNL(double x) {
    if (x <= -6.21460800000000013e+00) return -6.26590100000000039e+00;
    if (x >= -9.16290999999999967e-01) return -4.46540800000000004e+00;
...
inline double hagedornPSI(double x) {
    if (x <= 1.00000000000000002e-02) return 1.00000000000000000e+00;
    if (x >= 8.99999999999999967e-02) return 1.83000000000000007e+00;
...
inline double dunsRosF1(double x) {
    if (x <= -4.60517000000000021e+00) return 2.23143499999999995e-01;
    if (x >= 4.05465000000000020e-01) return -5.12933000000000000e-02;
...
inline double dunsRosF2(double x) {
    if (x <= -4.19970499999999980e+00) return -1.42711600000000005e+00;
    if (x >= 4.05465000000000020e-01) return -2.87681999999999993e-01;
...
inline double dunsRosF3(double x) {
    if (x <= -5.80914299999999972e+00) return -1.86329999999999996e-01;
    if (x >= 4.05465000000000020e-01) return 1.41098699999999999e+00;
...
inline double dunsRosF4(double x) {
    if (x <= -5.80914299999999972e+00) return -5.00000000000000000e+00;
    if (x >= -2.99573199999999984e+00) return 5.50000000000000000e+01;
...
inline double dunsRosF5(double x) {
    if (x <= -5.80914299999999972e+00) return -1.52326000000000006e+00;
    if (x >= 4.05465000000000020e-01) return -2.25379500000000021e+00;
...
inline double dunsRosF6(double x) {
    if (x <= -5.80914299999999972e+00) return 4.79999999999999982e-01;
    if (x >= 4.05465000000000020e-01) return 1.73999999999999999e+00;
...
inline double dunsRosF7(double x) {
    if (x <= -5.80914299999999972e+00) return -2.07944199999999979e+00;
    if (x >= 4.05465000000000020e-01) return -3.72970200000000007e+00;
...
inline double dunsRosFrictionCorrection(double x) {
    if (x <= -6.90775499999999987e+00) return 0.00000000000000000e+00;
    if (x >= 6.21460800000000013e+00) return -1.57021699999999997e+00;
...
inline double dunsRosTransitionY1(double x) {
    if (x <= 2.99573199999999984e+00) return 2.00000000000000000e+00;
    if (x >= 4.24849500000000013e+00) return 1.00000000000000000e+00;
...
inline double dunsRosTransitionY2(double x) {
    if (x <= 2.99573199999999984e+00) return 5.50000000000000044e-01;
    if (x >= 4.24849500000000013e+00) return 1.10000000000000009e+00;
...
inline double orkiszewskiC2_ReL2900(double x) {
    if (x <= 3.00000000000000000e+03) return 1.50000000000000000e+00;
    if (x >= 8.00000000000000000e+03) return 1.08000000000000007e+00;
...
inline double orkiszewskiC2_ReL6000(double x) {
    if (x <= 3.00000000000000000e+03) return 1.70999999999999996e+00;
    if (x >= 8.00000000000000000e+03) return 1.16500000000000004e+00;
...
inline double orkiszewskiC2(double reB, double reL) {
    ...
    if (reL <= 2900.0) return 1.0 + (reL / 2900.0) * (c2_2900 - 1.0);
    if (reL >= 6000.0) return c2_6000;
...
inline double eatonHoldup(double x) {
    if (x <= -6.90775999999999968e+00) return 3.00000000000000006e-03;
    if (x >= 4.60517000000000021e+00) return 1.00000000000000000e+00;
...
inline double flaniganPhi(double x) {
    if (x <= 0.00000000000000000e+00) return 1.00000000000000000e+00;
    if (x >= 4.80000000000000000e+01) return 5.99999999999999978e-02;
...
inline double duklerFrictionRatio(double x) {
    if (x <= -9.21034000000000042e+00) return 1.35000000000000009e+00;
    if (x >= 0.00000000000000000e+00) return 1.07000000000000006e+00;
...
inline double duklerHoldupCol0(double x) {
    if (x <= -9.21034037197618183e+00) return -1.89711998488588129e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol1(double x) {
    if (x <= -9.21034037197618183e+00) return -3.50655789731998180e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol2(double x) {
    if (x <= -9.21034037197618183e+00) return -4.46540824361293254e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol3(double x) {
    if (x <= -9.21034037197618183e+00) return -5.29831736654803631e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol4(double x) {
    if (x <= -9.21034037197618183e+00) return -6.26590139280974245e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol5(double x) {
    if (x <= -9.11503019217185795e+00) return -6.90775527898213682e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol6(double x) {
    if (x <= -8.80487526386801811e+00) return -6.90775527898213682e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol7(double x) {
    if (x <= -8.51719319141623821e+00) return -6.90775527898213682e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol8(double x) {
    if (x <= -8.18072095479502437e+00) return -6.90775527898213682e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol9(double x) {
    if (x <= -7.41858090274812820e+00) return -6.90775527898213682e+00;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupCol10(double x) {
    if (x <= -1.38155105579642736e+01) return -1.38155105579642736e+01;
    if (x >= 0.00000000000000000e+00) return 0.00000000000000000e+00;
...
inline double duklerHoldupByColumn(double logNoSlipHoldup, int colIndex) {
    switch (colIndex) {
        case 0: return duklerHoldupCol0(logNoSlipHoldup);
        case 1: return duklerHoldupCol1(logNoSlipHoldup);
        case 2: return duklerHoldupCol2(logNoSlipHoldup);
        case 3: return duklerHoldupCol3(logNoSlipHoldup);
        case 4: return duklerHoldupCol4(logNoSlipHoldup);
        case 5: return duklerHoldupCol5(logNoSlipHoldup);
        case 6: return duklerHoldupCol6(logNoSlipHoldup);
        case 7: return duklerHoldupCol7(logNoSlipHoldup);
        case 8: return duklerHoldupCol8(logNoSlipHoldup);
        case 9: return duklerHoldupCol9(logNoSlipHoldup);
        case 10: return duklerHoldupCol10(logNoSlipHoldup);
        default: return logNoSlipHoldup;
    }
}
...
inline double duklerHoldup(double noSlipHoldup, int colIndex) {
    if (noSlipHoldup <= 0.0) return 0.0;
    if (noSlipHoldup >= 1.0) return 1.0;
...
inline double mukherjeeFrictionRatio(double x) {
    if (x <= -3.00000000000000000e+00) return 1.00000000000000000e+00;
    if (x >= 1.00000000000000000e+00) return 1.00000000000000000e+00;
...
inline double mukherjeeHoldupRatio(double x) {
    if (x <= -3.00000000000000000e+00) return -3.00000000000000000e+00;
    if (x >= 1.00000000000000000e+00) return 1.00000000000000000e+00;

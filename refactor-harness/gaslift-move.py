...
FUNCTIONS = {
    ...
    "conectaColuna": {"new_name": "connectTubing", "arguments": ""},
    "solveLinGas": {"new_name": "solveGasLine", "arguments": ""},
    "conectaColunaPerm": {"new_name": "connectTubingSteady", "arguments": ""},
    "IniciaconectaColunaPerm": {"new_name": "initializeTubingConnectionSteady", "arguments": ""},
    "delpGasPerm": {"new_name": "steadyGasPressureDrop", "arguments": "i"},
    "delpInjPerm": {"new_name": "steadyInjectionPressureDrop", "arguments": "i"},
    "RenovaPresGasPerm": {"new_name": "updateSteadyGasPressure", "arguments": "i"},
    "calcVazGasPerm": {"new_name": "computeSteadyGasFlowRate", "arguments": "i"},
    "IniciaVazValvGasPerm": {"new_name": "initializeSteadyValveGasFlowRate", "arguments": "i"},
    "RenovaTempGasPerm": {"new_name": "updateSteadyGasTemperature", "arguments": "i"},
}
